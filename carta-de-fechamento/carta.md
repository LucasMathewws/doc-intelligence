...
edital até esta versão final da carta, coube em uma única manhã, entre 8h52 e aproximadamente
10h30, cerca de 1h38 corridas, sem pausa — incluindo uma segunda passada, a meu pedido depois da
primeira entrega: uma revisão completa comparando spec, ADRs e código linha a linha com o edital,
que achou e corrigiu dois bugs de verdade (não só imprecisão de texto) num dos sete fatos do
ambiente. Isso
está registrado em detalhe em `ia/prompts.md` e `ia/README.md` porque muda a leitura de tudo o que
vem antes nesta carta: o padrão de decisão não foi "o que é tecnicamente melhor", foi "o que é
honesto e defensável dentro do tempo que realmente existia" — inclusive esta resposta.
